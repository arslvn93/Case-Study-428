const config = {
  ...
  header: {
    ...
    subheadline: "Secured a turn-key 2-unit rental property in <strong>Woodbridge's exclusive areas</strong> that delivers <a href=\"#\">immediate cash flow and long-term appreciation</a> for generational wealth building"
  },
  ...
  mainBox: {
    summary: {
      ...
      subTitle: "Summary",
      paragraphs: [
        "Meet my investor client—a <strong>savvy buyer who understood the power of real estate for building generational wealth</strong>. They had a specific vision: find a turn-key 2-unit rental property in Woodbridge's exclusive areas that would deliver immediate cash flow and long-term appreciation for their children's future.",
        "In a market where <strong>every desirable property attracted massive competition with 10+ offers</strong>, we crafted a bulletproof strategy. Through strategic positioning with larger deposits, shorter closings, and fewer conditions—plus my investment expertise and negotiation skills—we <strong>won against 9 other offers on a $999,000 listed property, securing it for $1,260,000</strong> with immediate positive cash flow and premium tenants at top-dollar rent."
      ]
    },
    sidebar: {
      image: { src: "https://images.unsplash.com/photo-1511367461989-f85a21fda167?fit=crop&w=200&q=80", alt: "{{companyName}} agent" },
      paragraphs: [
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "<strong>Key Victory Stats:</strong><br>• <strong>9 COMPETING OFFERS DEFEATED</strong><br>• <strong>IMMEDIATE POSITIVE CASH FLOW ACHIEVED</strong><br>• <strong>3-5 YEAR EQUITY GROWTH PROJECTED</strong>"
      ],
      image: { src: "https://images.unsplash.com/photo-1506744038136-46273834b3fb?fit=crop&w=800&q=80", alt: "Secured investment property" }
    },
    {
      type: "standard",
    ...
    },
    {
      type: "ctaBanner",
      ctaBannerContent: {
        subhead: "Trusted By Smart Investors",
        headline: "Get Your FREE Investment Property Analysis<br>and Discover the 3 Specific Strategies<br>That Won Against 9 Other Offers",
        smallText: "Even in today's challenging market ➡️"
      }
    }
  ],
